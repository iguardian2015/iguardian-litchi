...
public class SessionManagement {
	...
	//private static final String PREF_NAME2 = "iguardian2";
	 ...
	 * */
	public void createLoginSession(String username, String pass , String db) {
...
/*	public void register_id(String reg_id) {
	...
	/*public HashMap<String, String> get_password() {
		HashMap<String, String> user = new HashMap<String, String>();
		// user name
		//user.put(KEY_NAME, pref.getString(KEY_NAME, null));
	...
	private class delete_reg_id extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				nameValuePairs.add(new BasicNameValuePair("reg_id", regId)); // $Edittext_value
				// =
				Log.i("id", regId);
